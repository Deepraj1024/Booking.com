...
const PlaceScreen = () => {
  ...
  const data = [
    {
      ...
      properties: [
        {
          id: '10',
          name: 'FabHotel Zeke City Palace',
          image:
  ...
  const handleSort = type => {
    ...
    updatedData.forEach(place => {
      place.properties.sort((a, b) =>
        type === 'lowToHigh'
    ...
    <View>
      ...
      >
        <Pressable style={{ flexDirection: 'row', alignItems: 'center' }}>
          <FontAwesome name="exchange" size={25} color="gray" />
          <Text
            style={{
              fontSize: 16,
              fontWeight: '500',
        ...
        >
          <Ionicons name="filter" size={25} color="gray" />
          <Text
            style={{
              fontSize: 16,
              fontWeight: '500',
